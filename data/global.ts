...
export const footer: Footer = {
    columns: [
        ...
        },
        {
            ...
            links: [
                {
                    name: "GitHub",
                    link: "https://github.com/Saurabh-Biware",
                    icon: `${process.env.NEXT_PUBLIC_BASE_URL}static/icons/github-f.svg`,
                    leavesWebsite: true,
                },
                {
                    name: "LinkedIn",
                    link: "https://www.linkedin.com/in/saurabh-biware/",
                ...
                {
                    name: "Email",
                    link: "mailto:saurabhbiware@gmail.com",
    ...
    support: {
        buymeacoffee: "saurabhbiware",
        paypal: "saurabhbiware",
