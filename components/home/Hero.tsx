...
function Hero() {
    return (
        <>
            ...
            >
                <p className="text-xl mb-5">Hey, I'm Saurabh.</p>
                <h1 className="heroTitle inline-block max-w-2xl lg:max-w-4xl  w-auto relative text-5xl md:text-6xl lg:text-7xl tracking-tighter mb-10 font-bold heroShinyBg">
                    I enjoy{" "}
                    <span className="heroShiny1 text-fun-pink">building</span>{" "}
                    and{" "}
                    ...
                    <img
                        ...
                        src={`${
                            process.env.NEXT_PUBLIC_BASE_URL || "/"
                        }static/doodles/hero/nextjs.svg`}
                    />
                    <img
                        alt="coder"
                    ...
                    <img
                        ...
                        src={`${
                            process.env.NEXT_PUBLIC_BASE_URL || "/"
                        }static/doodles/hero/paintbrush.svg`}
                    />
                    <img
                        alt="pop1"
