...
class Projects extends Component {
    ...
    render() {
        let CovidDetails = (
            <React.Fragment>
                <label>
                    COVID-19 Global | India - Get Realtime coronavirus updates
                    for India and global. Analytics of all the affected
                    countries with the number of confirmed, recovered, deaths
                    and active cases.
                </label>
                <br />
                <label>
                    Dashboard created in ReactJS with ReCharts,
                    React-Google-Charts, React-Simple-Maps, React-Table.
                </label>
            </React.Fragment>
        );
        ...
        let SharedComponents = (
            <React.Fragment>
                ...
                <br />
                <label>
                    By reusing your own components you can save development
                    time, keep your UI consistent across applications and let
                    your whole team build together. No need to create a UI
                    library for reusable components across apps.
                </label>
                <br />
                <label>
                    Create Shared UI App to create UI components. Deploy Shared
                    UI App and Dynamically load a React Component from that URL
                    using remote-component.
                </label>
                <br />
                <label>
                    You can also add shared styles and common files in Shared
                    App which you want to reuse.
                </label>
            </React.Fragment>
        );
        ...
        let myProfileDetails = (
            <React.Fragment>
                <label>
                    The project is based on multiple skills search on a single
                    platform, Users can search multiple skills and it displays
                    related to that skills. If user wants any engineer for build
                    software, if a user wants any architecture or if users want
                    any electricians etc. then users can go to our website and
                    search the skill or person which they want and our system
                    displays all registered persons details and description and
                ...
                <br />
                <label>
                    In the home page of the system, an Only search bar is
                    provided and the user can log in and registers from the
                    homepage.
                </label>
                <br />
                <label>
                    ...
                    The user can search skill or person by name and our system
                    is displays the details of all the registered users of that
                    particular skill. the user can also visit their website
                    which is built in our system and contact them by their
                    details provided on their website. Users can also view that
                    person's past portfolio and their education details also.
                </label>
                <br />
                <label>
                    <span style={{ fontWeight: "bold", color: "#fcca7b" }}>
                    ...
                    One of the major parts in this system is sub admin. SubAdmin
                    is the person who has a particular skill in particular area,
                    If that person wants the work based on their skill than they
                    Will register in our system and add the details.If Super
                    Admin Approve that person then that person can add it's
                    details into the system, SubAdmin can add following Details
                    into the system.
                </label>
                <br />
                <label>
                    ...
                    They can add their education details and degree details and
                    also updates and delete the educations. <br />
                    <span style={{ fontWeight: "bold", color: "#fcca7b" }}>
                        3. Skill:
                    </span>{" "}
                    ...
                    Users can add their Portfolio details, In this user can add
                    their past work or experience details with images. <br />
                    <span style={{ fontWeight: "bold", color: "#fcca7b" }}>
                        5. Portfolio Image:{" "}
                    </span>
                    Users can add their particular portfolio images, User can
                    add 10 images at a time. <br />
                    <span style={{ fontWeight: "bold", color: "#fcca7b" }}>
                        6. ContactUs:
                    </span>{" "}
                    ...
                    User can add the keyword for Searching.This is used and help
                    us to find the particular skill. <br />
                    <span style={{ fontWeight: "bold", color: "#fcca7b" }}>
                        8. Theme:{" "}
                    </span>
                    User can select and apply theme for his/her choice, This
                    theme displays all details about that particular
                    user(SubAdmin) and the user can also preview that theme.
                    this theme is used for building a website for that
                    particular user when end user searches that person than the
                    end user can view this website for the view that person
                    details.
                </label>
                <br />
                <label>
                    ...
                    SuperAdmin is Handle all the User who is registered in the
                    system, SuperAdmin can approve, Disapprove and suspend the
                    existing users and also view the details about how many
                    users are registered today, how many users are active now,
                    and how many users are suspended. these details are
                    displayed in the dashboard of the admin side. Super admin
                ...
                <label>
                    ...
                    SuperAdmin can Add and Update category.This is used in the
                    subAdmin side.Subadmin can select that category. <br />
                    <span style={{ fontWeight: "bold", color: "#fcca7b" }}>
                        2. Field:
                    </span>{" "}
                    SuperAdmin can Add Fields For particular category and also
                    updates the fields. <br />
                    <span style={{ fontWeight: "bold", color: "#fcca7b" }}>
                        3. Type:
                    </span>{" "}
                    SuperAdmin can Add and update user type (Employee,
                    CEO,etc.). <br />
                    <span style={{ fontWeight: "bold", color: "#fcca7b" }}>
                        4. Theme:
                    </span>{" "}
                    SuperAdmin can Add and Update Theme for providing to sub
                    admin.
                </label>
            </React.Fragment>
        );
        ...
        let autoAttendanceDetails = (
            <React.Fragment>
                <label>
                    The purpose of this system is to provide a better way of
                    taking attendance during lecture. A solution that will take
                    less time and effort on faculty side as well as the student
                    side .The system will help them in keeping track of
                    attendance and make it easier for faculty to check for
                    grading.
                    <br />
                    The scope of the project is DAIICT in which the software
                    would be installed by Admin as well as Students. The project
                    is developed as an Android Application, Web Application. The
                    project would operate only under the boundaries of DAIICT.
                </label>
                ...
                <label>
                    By using this application faculty will login to the system
                    and select the course and session period for QR code, and
                    then QR code is displayed on the screen, students will scan
                    QR code in their mobiles, student must scan 70% of QR that
                    are displayed in the screen, after session time is over
                    faculty closes the attendance.
                </label>
            </React.Fragment>
        );
        ...
        let krumaDetails = (
            <React.Fragment>
                <label>
                    Kruma Chemicals is manufacturing a wide range of nutritional
                    protein powder and weight gainer and related to the food
                    product. I develop an Ionic app For Kruma Chemicals. This
                    app is related to product list and price list of the
                    company's product.
                </label>
            </React.Fragment>
        );
        ...
        let TableDetails = (
            <React.Fragment>
                ...
                <label>
                    ...
                    You have to pass data and head objects in data prop. head is
                    for Header. <br />
                    <span style={{ fontWeight: "bold", color: "#fcca7b" }}>
                        tableStyle -
                    </span>{" "}
                    ...
                    Number Of Records that Shows in single page. You can Onle
                    use 5,10,20,25,50. <br />
                    <span style={{ fontWeight: "bold", color: "#fcca7b" }}>
                        errormsg -
                    </span>{" "}
                    ...
                    Function. You can redirect to another page by onRowClick,
                    you can call any function by onRowClick, You can also get
                    Row Data by onRowClick using "(row = console.log(row))".
                </label>
            </React.Fragment>
        );
        ...
        let TimesAgoDetails = (
            <React.Fragment>
                <label>
                    React-TimesAgo is a component that takes a date as a prop
                    and returns a time-span with live updating date.
                </label>
                <br />
                <label>
                    <span style={{ fontWeight: "bold", color: "#fcca7b" }}>
        ...
        let reactTimeLineCharts = (
            <React.Fragment>
                ...
                <label>
                    ...
                    true or false (if true set to default react-google-charts
                    style)
                    <br />
                    <span style={{ fontWeight: "bold", color: "#fcca7b" }}>
                        loader -
        ...
        let delimiterDetails = (
            <React.Fragment>
                <label>
                    Array Delimiter(Deliminate last number or string with "and"
                    or "or").
                </label>
                <br />
                <label>
        ...
        let validateDetails = (
            <React.Fragment>
                <label>
                    Input validation for null, undefined, Infinity and NaN
                    values.{" "}
                </label>
                <br />
                <label>
        ...
        let packageDetails = (
            <React.Fragment>
                ...
                <br />
                <label>
                    BoilerPlate code is created by Create React App 1, Follow
                    Instructions given to github pages for create package.
                </label>
                <br />
                <label style={{ fontWeight: "bold", color: "#fcca7b" }}>
                    package.json
        ...
        let MicroFrontend = (
            <React.Fragment>
                ...
                <label>
                    Micro-frontend architecture is a design approach in which a
                    front-end app is decomposed into individual,
                    semi-independent “microapps” working loosely together.
                </label>
                <label>
                    Th applications are loaded into a micro-frontend container.
                    The container runs it as of the micro frontend is its own
                    component and provides seamless workflow to users.
                </label>
            </React.Fragment>
        );
        ...
        let multiReact = (
            <React.Fragment>
                <label>
                    Multiple React apps created by CRA in single port through
                    docker containers and nginx.
                </label>
                <label>
        ...
        let restaurantApp = (
            <React.Fragment>
                <label>
                    Restaurant CRUD app is sample project with CRUD operations
                    build with ant-design, bootstrap4 and ReactJs.
                </label>
            </React.Fragment>
        );
