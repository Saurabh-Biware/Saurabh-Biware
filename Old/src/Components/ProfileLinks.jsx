...
class ProfileLinks extends Component {
    render() {
        let generateLinks = (link, name, icon) => {
            return (
                <label
                    style={{ fontSize: 28, marginLeft: 10, marginRight: 10 }}
                >
                    <a
                        href={link}
        ...
        return (
            <div>
                ...
                <label style={{ fontSize: 42, marginTop: 50 }}>
                    <Typist cursor={{ show: false }}>Saurabh Biware</Typist>
                </label>
                <br />
                <label style={{ fontSize: 18, marginTop: 50 }}>
                    Skilled in Full Stack Software Development, ReactJs, PHP,
                    JAVA, Redux, MySQL
                </label>
                <br />
                <div
                ...
                >
                    {generateLinks(
                        "https://github.com/saurabhbiware",
                        "Github",
                        faGithub
                    )}
                    {/* {generateLinks(
                    ...
                    {generateLinks(
                        "https://www.linkedin.com/in/saurabhbiware",
                        "LinkedIn",
                        faLinkedin
                    )}
                    {generateLinks(
                    ...
                    {generateLinks(
                        "https://www.npmjs.com/~miteshtagadiya",
                        "NPM",
                        faNpm
                    )} */}
                    ...
                    >
                        <a
                            href="https://cssbattle.dev/player/saurabhbiware"
                            style={{ textDecoration: "none", color: "#7ef0ff" }}
                            target="_blank"
